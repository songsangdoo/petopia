...
<body>
	...
	<main id="main">
		...
		<form action="notice_modify_ok.do" method="post" name="wfrm" enctype="multipart/form-data">
		...
		<div>
			...
			<div class="input-group mb-3">
			  ...
			  <c:if test='<%= data.getN_fix().equals("Y") %>'>
			    <option value="Y" selected>YES</option>
			    <option value="N">NO</option>
			  </c:if>
			  <c:if test='<%= data.getN_fix().equals("N") %>'>
		...
		<div>
			<div class="col">
				<div class="input-group mb-3">
					...
					<input type="text" class="form-control" name="subject" value="<%= data.getN_subject() %>">
				</div>
			</div>
		...
		<div class="input-group mb-3">
			...
			<textarea class="form-control" name="content" rows="10" style="resize: none;"><%= data.getN_content().replaceAll("<br>", "\n") %></textarea>
		</div>
