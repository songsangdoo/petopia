...
<body>
	...
	<main id="main">
		...
		<form action="freeboard_modify_ok.do" method="post" name="wfrm" enctype="multipart/form-data">
		<input type="hidden" name="fb_seq" value="<%= fb_seq %>">
		<div class="input-group mb-3">
			<span class="input-group-text">제 목</span>
			<input type="text" class="form-control" name="subject" value="<%= data.getFb_subject()%>">
		</div>

		<div class="input-group mb-3">
			<span class="input-group-text">내 용</span>
			<textarea class="form-control" name="content" rows="10" style="resize: none;"><%= data.getFb_content().replaceAll("<br>", "\n") %></textarea>
		</div>
