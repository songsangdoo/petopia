...
<body>
	...
	<main id="main">
		...
		<form action="freeboard_write_ok.do" method="post" name="wfrm" enctype="multipart/form-data">
		...
		<div class="p-2">
		<input type="button" value="목 록" class="btn btn-outline-primary" style="cursor: pointer;" onclick="location.href='freeboard_list.do'" />
