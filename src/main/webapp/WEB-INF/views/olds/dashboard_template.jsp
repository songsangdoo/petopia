	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="manage.do"> <span
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						<a class="sidebar-link" href="/manage.do">
              				<i class="align-middle" data-feather="sliders"></i> <span class="align-middle">종합정보</span>
            			</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link" href="/manage_user.do">
              				<i class="align-middle" data-feather="user"></i> <span class="align-middle">유저관리</span>
            			</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link" href="/manage_event.do">
              				<i class="align-middle" data-feather="log-in"></i> <span class="align-middle">상품관리</span>
            			</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link" href="#">
              				<i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">추가예정</span>
            			</a>
					</li>
				</ul>
			</div>
					...
					<ul class="navbar-nav navbar-align">
							...
							<div
								...
								<div class="list-group">
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="assets/dashimg/avatars/avatar-5.jpg"
										...
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="assets/dashimg/avatars/avatar-2.jpg"
													class="avatar img-fluid rounded-circle"
													alt="William Harris">
											</div>
											<div class="col-10 ps-2">
										...
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="assets/dashimg/avatars/avatar-4.jpg"
													class="avatar img-fluid rounded-circle"
													alt="Christina Mason">
											</div>
											<div class="col-10 ps-2">
										...
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="assets/dashimg/avatars/avatar-3.jpg"
													class="avatar img-fluid rounded-circle"
													alt="Sharon Lessman">
											</div>
											<div class="col-10 ps-2">
						...
						<li class="nav-item dropdown"><a
							...
							href="#" data-bs-toggle="dropdown"> <img
								src="assets/dashimg/avatars/avatar.jpg"
